...
| `components/FeaturedRows.tsx` | Home page — geo row + curated horizontal scroll rows; `max-w-[1924px]` centred container; always-visible edge fades, hover-only arrows |
